package io.lh.rpc.proxy.asm.factory;
    ...
    private static void addClinit(ClassWriter cw, Class<?>[] interfaces, String proxyClassName) {
        ...
        for (Class<?> anInterface : interfaces) {
            for (int i = 0; i < anInterface.getMethods().length; i++) {
                ...
                mv.visitMethodInsn(Opcodes.INVOKESTATIC, Type.getInternalName(Class.class), "forName", "(Ljava/lang/String;)Ljava/lang/Class;");
